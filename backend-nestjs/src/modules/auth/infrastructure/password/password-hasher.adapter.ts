 ...
 * Passwords are hashed (one-way) with bcrypt—never stored or transmitted in plaintext.
 * Infrastructure layer implementation of PasswordHasherPort using bcryptjs (pure JS, no native deps).
 */
@Injectable()
